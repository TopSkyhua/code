 ...
 *
 * @Author : Tophua
 * @Date : Created in 16:41 2020-02-14
 * @Modified By :
 * @Version: : v0.1
 */
public class CodeMpApplication {
    /**
     * <p>
     * 读取控制台内容
     * </p>
...
//        strategy.setSuperEntityColumns("id");
        strategy.setInclude(scanner("表名，多个英文逗号分割\n（查询数据库所有表名Sql：select table_name from information_schema.tables where table_schema='db_name';）").split(","));
